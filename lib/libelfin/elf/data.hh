...
// ELF32 format.
    ...
    static inline constexpr shf
    operator&(shf
    a,
    shf b
    ) {
    return (shf)((std::uint64_t)
    a &(std::uint64_t)
    b);
}
...
static inline shf &operator&=(shf & a, shf
b)
{
a = a & b;
return
...
static inline constexpr pf
operator&(pf
a,
pf b
)
{
return (pf)((std::uint64_t)
a &(std::uint64_t)
b);
}
...
static inline pf &operator&=(pf & a, pf
b)
{
a = a & b;
return
